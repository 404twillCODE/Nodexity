...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  server: {
    ...
    getArkMaps: () => ipcRenderer.invoke('get-ark-maps'),
    ...
    installEssentialsXFromGitHub: (serverName) => ipcRenderer.invoke('install-essentialsx-from-github', serverName),
    ...
    listMods: (serverName) => ipcRenderer.invoke('list-mods', serverName),
    deleteMod: (serverName, modName) => ipcRenderer.invoke('delete-mod', serverName, modName),
    checkJarSupportsMods: (serverName) => ipcRenderer.invoke('check-jar-supports-mods', serverName),
    getModrinthMods: (minecraftVersion, loader, limit) => ipcRenderer.invoke('get-modrinth-mods', minecraftVersion, loader, limit),
    installModrinthMod: (serverName, projectId, minecraftVersion) => ipcRenderer.invoke('install-modrinth-mod', serverName, projectId, minecraftVersion),
    installGeyserFloodgate: (serverName, serverPort) => ipcRenderer.invoke('install-geyser-floodgate', serverName, serverPort),
